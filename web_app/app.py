...
app_ui = ui.page_fluid(
    ...
    ui.div(
        ui.div(
            ...
            ui.h1("Mini horno solar · Web 0.1"),
            ui.p("Ejecucion local en el navegador con Python y WebAssembly"),
            class_="brand-block",
        ),
    ...
    ui.div(
        ...
        ui.tags.main(
            ui.div(
                ...
                ui.div(
                    ui.input_action_button("toggle_run", "INICIAR / PAUSAR", class_="primary-action"),
                    ui.input_action_button("reset", "REINICIAR", class_="secondary-action"),
            ...
            ui.div(
                ui.navset_card_tab(
                    ui.nav_panel("Gemelo 3D", ui.output_ui("scene_view")),
...
def server(input, output, session) -> None:  # type: ignore[no-untyped-def]
    ...
    @output
    @render.ui
    def scene_view() -> object:
        revision.get()
        return ui.HTML(scene_svg(state.snapshot()))
